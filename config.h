...
GT_API GT_FlashProgram(unsigned long offset, short count, short *pData, long *pRetry = nullptr);
...
GT_API GTN_FlashProgram(short core, unsigned long offset, short count, short *pData, long *pRetry = nullptr);
