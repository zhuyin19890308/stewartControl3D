...
#define RTN_nullptr_POINT						-102 /* the param point input is nullptr */
#define RTN_ERR_ORDER						-103 /* call the function order is wrong, some msg isn't validable */
#define RTN_PCI_nullptr							-104 /* the pci address is empty, can't access the pci device*/
...
GT_API GT_OpenAllDevice(short channel = 5, short param = 1, char *pFile = nullptr, short *pDeviceCount = nullptr);
...
GT_API GT_GetTime(ETimeElapse item, unsigned long *pTime, unsigned long *pTimeMax, unsigned long *pValue = nullptr);
...
GT_API GT_GetAxisPrfPosCompensate(short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
...
GT_API GTN_OpenRingNet(short channel = 5, short param = 1, char *pFile = nullptr, short index = 1, long count = 1);
...
GT_API GTN_GetClock(short core, unsigned long *pClock, unsigned long *pLoop = nullptr);
GT_API GTN_GetClockHighPrecision(short core, unsigned long *pClock);
GT_API GTN_ClearTime(short core, ETimeElapse item);
GT_API GTN_GetTime(short core, ETimeElapse item, unsigned long *pTime, unsigned long *pTimeMax, unsigned long *pValue = nullptr);
...
GT_API GTN_GetSts(short core, short axis, long *pSts, short count = 1, unsigned long *pClock = nullptr);
...
GT_API GTN_GetPrfPos(short core, short profile, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetPrfVel(short core, short profile, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetPrfAcc(short core, short profile, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetPrfMode(short core, short profile, long *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAxisPrfPos(short core, short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAxisPrfPosCompensate(short core, short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAxisPrfVel(short core, short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAxisPrfAcc(short core, short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAxisEncPos(short core, short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAxisEncVel(short core, short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAxisEncAcc(short core, short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAxisError(short core, short axis, double *pValue, short count = 1, unsigned long *pClock = nullptr);
...
GT_API GT_AddTriggerDeltaCheckpoint(short index, short mode, long offset, short fifo = 0, short *pIndex = nullptr);
...
GT_API GTN_AddTriggerDeltaCheckpoint(short core, short index, short mode, long offset, short fifo = 0, short *pIndex = nullptr);
...
GT_API GT_PvtTableMove(short tableId, long distance, double vm, double am, double jm, double *pTime = nullptr);
GT_API GT_PvtTableMove2(short tableId, long distance, double vm, double am, double jm, double *pTime = nullptr);
GT_API GT_PvtTableMovePercent(short tableId, long distance, double vm,
                              ...
                              double *pVel = nullptr, double *pAcc = nullptr, double *pDec = nullptr, double *pTime = nullptr);
...
GT_API GTN_PvtTableMove(short core, short tableId, long distance, double vm, double am, double jm, double *pTime = nullptr);
GT_API GTN_PvtTableMove2(short core, short tableId, long distance, double vm, double am, double jm, double *pTime = nullptr);
...
GT_API GTN_GetGearMaster(short core, short profile, short *pMasterIndex, short *pMasterType = nullptr, short *pMasterItem = nullptr);
GT_API GTN_SetGearRatio(short core, short profile, long masterEven, long slaveEven, long masterSlope = 0);
GT_API GTN_GetGearRatio(short core, short profile, long *pMasterEven, long *pSlaveEven, long *pMasterSlope = nullptr);
...
GT_API GT_GetFollowMasterEx(short profile, short *pMasterIndex, short *pMasterType = nullptr, short *pMasterItem = nullptr);
...
GT_API GT_GetFollowEventEx(short profile, short *pEvent, short *pMasterDir, long *pPos = nullptr);
...
GT_API GT_FollowDataPercent2Ex(short profile, double masterSegment, double slaveSegment, double velBeginRatio, double velEndRatio, short percent = 100, short *pPercent1 = nullptr, short fifo = 0);
...
GT_API GTN_GetFollowMaster(short core, short profile, short *pMasterIndex, short *pMasterType = nullptr, short *pMasterItem = nullptr);
...
GT_API GTN_GetFollowEvent(short core, short profile, short *pEvent, short *pMasterDir, long *pPos = nullptr);
...
GT_API GTN_GetFollowMasterEx(short core, short profile, short *pMasterIndex, short *pMasterType = nullptr, short *pMasterItem = nullptr);
...
GT_API GTN_GetFollowEventEx(short core, short profile, short *pEvent, short *pMasterDir, long *pPos = nullptr);
...
GT_API GTN_FollowDataPercent2Ex(short core, short profile, double masterSegment, double slaveSegment, double velBeginRatio, double velEndRatio, short percent = 100, short *pPercent1 = nullptr, short fifo = 0);
...
typedef struct CrdPrm
{
    ...
    short profile[32];                             // 关联profile和坐标轴
...
GT_API GT_GetAuAdc(short adc, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GT_GetAuAdcValue(short adc, short *pValue, short count = 1, unsigned long *pClock = nullptr);
...
GT_API GT_GetEncVelEx(short encoder, double *pValue, short count = 1, unsigned long *pClock = nullptr);

GT_API GT_SetPlsPos(short encoder, long encPos);
GT_API GT_GetPlsPos(short pulse, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GT_GetPlsVel(short pulse, double *pValue, short count = 1, unsigned long *pClock = nullptr);

GT_API GT_SetAuEncPos(short encoder, long encPos);
GT_API GT_GetAuEncPos(short encoder, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GT_GetAuEncVel(short encoder, double *pValue, short count = 1, unsigned long *pClock = nullptr);
...
GT_API GTN_GetDac(short core, short dac, short *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_SetAuDac(short core, short dac, short *pValue, short count = 1);
GT_API GTN_GetAuDac(short core, short dac, short *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAdc(short core, short adc, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAdcValue(short core, short adc, short *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAuAdc(short core, short adc, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAuAdcValue(short core, short adc, short *pValue, short count = 1, unsigned long *pClock = nullptr);
...
GT_API GTN_GetEncPos(short core, short encoder, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetEncPosPre(short core, short encoder, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetEncVel(short core, short encoder, double *pValue, short count = 1, unsigned long *pClock = nullptr);

GT_API GTN_SetPlsPos(short core, short encoder, long encPos);
GT_API GTN_GetPlsPos(short core, short pulse, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetPlsVel(short core, short pulse, double *pValue, short count = 1, unsigned long *pClock = nullptr);

GT_API GTN_SetAuEncPos(short core, short encoder, long encPos);
GT_API GTN_GetAuEncPos(short core, short encoder, double *pValue, short count = 1, unsigned long *pClock = nullptr);
GT_API GTN_GetAuEncVel(short core, short encoder, double *pValue, short count = 1, unsigned long *pClock = nullptr);
...
GT_API GT_ScanInit(TScanInit *pScanInit = nullptr, double jumpAcc = 0, double markAcc = 0, short crd = 0);
...
GT_API GTN_ScanInit(short core, TScanInit *pScanInit = nullptr, double jumpAcc = 0, double markAcc = 0, short crd = 1);
...
GT_API GTN_GetTerminalType(short core, short count, unsigned short *pType, short *pTypeConnect = nullptr);
...
GT_API GT_GetEcatDigitIn(short axis, unsigned long *pDigitIn);
...
GT_API GTN_GetEcatDigitIn(short core, short axis, unsigned long *pDigitIn);
